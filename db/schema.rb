...
ActiveRecord::Schema.define(version: 2019_02_13_025548) do
  ...
  create_table "combined_replay_data", force: :cascade do |t|
    ...
    t.boolean "p1_wins"
    t.jsonb "p1_deck_card_ids", default: [], null: false
    t.jsonb "p1_pre_mulligan_card_ids", default: [], null: false
    t.jsonb "p1_post_mulligan_card_ids", default: [], null: false
    ...
    t.boolean "p2_wins"
    t.jsonb "p2_deck_card_ids", default: [], null: false
    t.jsonb "p2_predicted_deck_card_ids", default: [], null: false
    t.string "game_type"
